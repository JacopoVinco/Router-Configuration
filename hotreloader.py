...
class KivyMDproject(MDApp, HotReloaderApp):  # NOQA: N801
    ...
    CLASSES = {'Root': 'libs.uix.baseclass.root', 'HomeScreen': 'libs.uix.baseclass.home_screen',
               'BTNavOne': 'libs.uix.baseclass.btnav_one', 'BTNavTwo': 'libs.uix.baseclass.btnav_two',
               'BTNavThree': 'libs.uix.baseclass.btnav_three'}  # NOQA: F821
